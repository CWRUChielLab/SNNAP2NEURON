...
NEURON {
	...
	RANGE
		Na_g, Na_e, Na_p, Na_A_SSA_h, Na_A_SSA_s,
		Na_A_SSA_p, Na_A_SSA_h, Na_A_SSA_s, Na_A_SSA_p, Na_A_tau_tx,
		Na_A_tau_h1, Na_A_tau_h1, Na_A_tau_tn, Na_A_tau_p1, Na_B_SSB_h,
		Na_B_SSB_s, Na_B_SSB_p, Na_B_tau_tx, Na_B_tau_h1, Na_B_tau_h1,
		Na_B_tau_tn, Na_B_tau_p1, K_g, K_e, K_p,
		...
		K_B_tau_h1, K_B_tau_tn, K_B_tau_p1, leak1_g, leak1_e
	GLOBAL
		Na_A_SSA, Na_A_tau, Na_B_SSB, Na_B_tau, K_A_SSA, K_A_tau, K_B_SSB, K_B_tau
